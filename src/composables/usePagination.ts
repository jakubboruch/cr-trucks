...
export function usePagination() {
  ...
  const getIPPFromLS = () => {
    return Number(JSON.parse(localStorage.getItem(PaginationEnum.ITEMS_PER_PAGE) || '{}')) || countOfItemsPerPage[0]
  }
  ...
  return { countOfItemsPerPage, getIPPFromLS, setIPPToLS, setTotalItems, numberOfPages, itemsPerPage }
}