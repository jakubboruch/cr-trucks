...
export function useTrucksAPI() {
  ...
  const createTruck = async (name: string | undefined, code: string | undefined, description: string | undefined, status: string | undefined) => {
    try {
  ...
  const updateTruck = async (id: string | undefined, name: string | undefined, code: string | undefined, description: string | undefined, status: string | undefined) => {
    if (!id) {
      return;
    }
    try {
